                ...
                <tbody class="divide-y divide-gray-100 bg-white">
                    <?php foreach ($clients as $client): ?>
                        <tr>
                            ...
                            <td class="px-4 py-2">
                                <span class="rounded-full bg-sky-50 px-2 py-1 text-xs font-semibold text-sky-700"><?= htmlspecialchars($client['status'], ENT_QUOTES) ?></span>
                            </td>
    ...
    <div class="lg:w-1/3">
        ...
        <form method="POST" action="/clients" class="mt-4 space-y-4 rounded bg-white p-4 shadow">
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700">Preferred vaqt</label>
                    <input type="time" name="preferred_time" class="mt-1 w-full rounded border border-gray-300 px-3 py-2">
                </div>
            </div>
            <div>
                <label class="block text-sm font-medium text-gray-700">Preferred kunlar</label>
                <input type="text" name="preferred_days" class="mt-1 w-full rounded border border-gray-300 px-3 py-2" placeholder="Mon,Wed,Fri">
            </div>
            <div>
                <label class="block text-sm font-medium text-gray-700">Teglar</label>
                <input type="text" name="tags" class="mt-1 w-full rounded border border-gray-300 px-3 py-2" placeholder="VIP, Office">
            </div>
            <div class="border-t pt-4">
                <h3 class="text-sm font-semibold text-gray-700">Manzil</h3>
                <div class="mt-2 space-y-2">
                    <input type="text" name="address_label" class="w-full rounded border border-gray-300 px-3 py-2" placeholder="Label (ixtiyoriy)">
